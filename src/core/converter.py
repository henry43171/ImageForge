...
class ImageConverter:
    ...
    # 轉檔
    def convert_images_in_folder(self, input_folder, output_folder, output_format):
        """
        將資料夾內所有圖片轉換成指定格式
        ...
        - 遇到不支援格式或錯誤會自動跳過
        """
        output_format_upper = self.format_map.get(output_format.upper())
    ...
    # 轉icon
    def convert_images_to_icon(self, input_folder, output_folder, icon_sizes=[(32,32)]):
        """
        將資料夾內所有圖片轉成 ICO
