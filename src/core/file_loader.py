...
class FileLoader:
    # 取得檔案清單
    def list_image_files(self, input_folder: str, exts: List[str] = None) -> List[str]:
        """
    ...
    # 儲存處理後的影像
    def save_images(self, images: List[Tuple[str, Image.Image]], input_folder: str, output_folder: str):
        """
